...
<header>
    ...
    <div class="navbar-buttons">
        ...
        <button class="navbar-button btn btn-danger">Logout</button>
    </div>
</header>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <button class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#viewModal" 
                                data-file="<?= htmlspecialchars(isset($document['file_path']) ? $document['file_path'] : '#'); ?>" 
                                title="View">
                            <i class="fas fa-eye"></i>
                        </button>

                        <!-- Print button -->
<a href="#" class="btn btn-success btn-sm" title="Print" onclick="printDocument(<?= htmlspecialchars($document['id']); ?>)">
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <!-- PDF Preview -->
                <iframe id="pdfPreview" class="w-100" style="height: 500px; border: 1px solid #ccc;" src="" hidden></iframe>
                <p id="noPdfMessage" class="text-center text-danger" hidden>No PDF to display.</p>
            </div>
        </div>
    </div>
</div>
...
<script>
    ...
    viewModal.addEventListener('show.bs.modal', function (event) {
        ...
        const filePath = button.getAttribute('data-file'); // Get the file path
